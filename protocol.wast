(module
 ...
 (data (i32.const 144) "verify\00")
 (data (i32.const 160) "transfer\00")
 (data (i32.const 176) "eosio.token\00")
 (data (i32.const 208) "Rejected. Require HOST in memo field\00")
 ...
 (data (i32.const 352) "Rejected. Only Core token is accepted by DACom Protocol for now.\00")
 (data (i32.const 432) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 496) "Rejected. Host is not founded.\00")
 (data (i32.const 528) "Rejected. Protocol is not active\00")
 (data (i32.const 576) "Rejected. Pool is Expired. Need manual refresh.\00")
 (data (i32.const 624) "You can purchase only whole pieces of LEPT. Specify the amount of the multiple purchase rate.\00")
 (data (i32.const 720) "Not enought LEPT in target pool\00")
 (data (i32.const 752) "Successful deposit in the DACom protocol\00")
 ...
 (data (i32.const 1552) "Rejected\00")
 ...
 (data (i32.const 1840) "Withdraw\00")
 (data (i32.const 1856) "Not possible to withdraw zero amount\00")
 (data (i32.const 1904) "black\00")
 (data (i32.const 1920) "white\00")
 (data (i32.const 1936) "multiplication overflow or underflow\00")
 (data (i32.const 1984) "multiplication underflow\00")
 (data (i32.const 2016) "multiplication overflow\00")
 (data (i32.const 2048) "Balance is not exist or already withdrawed\00")
 (data (i32.const 2096) "Account is not upgraded to Host. Please update your account and try again.\00")
 (data (i32.const 2176) "Protocol is not found. Set parameters at first\00")
 (data (i32.const 2224) "Protocol is already active and cannot be activated again\00")
 (data (i32.const 2288) "Protocol is already active and cannot be changed now.\00")
 (data (i32.const 2352) "Overlap factor must be greater then 10000 (1.0000) and less then 20000 (2.0000)).\00")
 (data (i32.const 2448) "Profit growth factor must be greater or equal 0 (0.0000) and less then 20000 (2.0000)).\00")
 (data (i32.const 2544) "Loss Percent must be greater then 0 (0%) and less or equal 10000 (100%)\00")
 (data (i32.const 2624) "Base Rate must be greater or equal 10 and less then 1e9\00")
 (data (i32.const 2688) "Size of Pool must be greater or equal 10 and less then 1e9\00")
 (data (i32.const 2752) "Pool Count must be greater or equal 4 and less or equal 1000\00")
 (data (i32.const 2816) "Pool Timeout must be greater or equal then 60 sec and less then 7884000\00")
 (data (i32.const 2896) "cannot pass end iterator to erase\00")
 (data (i32.const 2944) "cannot increment end iterator\00")
 (data (i32.const 2976) "The financial model of Protocol is Negative. Try with a different parameters\00")
 (data (i32.const 3056) "Tokens in the Box are exceeds the max supply. Try to decrease Protocol parameters.\00")
 (data (i32.const 3152) "Overlap rate is too small for Protocol operation. Try to increase Overlap parameter, Size of Pool or Base Rate\00")
 (data (i32.const 3264) "object passed to erase is not in multi_index\00")
 (data (i32.const 3312) "cannot erase objects in table of another contract\00")
 (data (i32.const 3376) "attempt to remove object that was not in multi_index\00")
 (data (i32.const 3440) "Purpose is a maximum 1024 symbols. Describe the idea shortly.\00")
 (data (i32.const 3504) "&#\00")
 (data (i32.const 3520) "Symbols \'&#\' is prohibited in purpose\00")
 (data (i32.const 3568) "Account is already upgraded to Host\00")
 (data (i32.const 3616) "Success Upgrade to DACom HOST\00")
 (data (i32.const 12048) "malloc_from_freed was designed to only be called after _heap was completely allocated\00")
 ...
 (func $_ZN4impl5applyEyyy (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64)
  ...
  (block $label$0
   ...
   (i64.store offset=32
    (get_local $13)
    (call $_ZN5eosio18unpack_action_dataINS_6verifyEEET_v)
   )
   (call $_ZN4impl13verify_actionERKN5eosio6verifyE
    (get_local $0)
    (i32.add
     (get_local $13)
     (i32.const 32)
 ...
 (func $_ZN5eosio18unpack_action_dataINS_6verifyEEET_v (result i64)
  (local $0 i32)
  (local $1 i64)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $_ZN4impl13verify_actionERKN5eosio6verifyE (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  (call $_ZN5eosio11multi_indexILy3607749778735104000ENS_7accountEJEE6modifyIZN4impl13verify_actionERKNS_6verifyEEUlRT_E_EEvRKS1_yOS8_
   (i32.add
    (get_local $5)
    (i32.const 8)
   )
 ...
 (func $_ZNK5eosio11multi_indexILy3607749778735104000ENS_7accountEJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  ...
  (block $label$2
   ...
   (drop
    (call $_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNS_7accountE
     (i32.add
      (get_local $8)
      (i32.const 32)
     )
 ...
 (func $_ZN5eosiorsINS_10datastreamIPKcEEEERT_S6_RNS_7accountE (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (i32.store offset=4
   (i32.const 0)
 ...
 (func $_ZN5eosio11multi_indexILy3607749778735104000ENS_7accountEJEE6modifyIZN4impl13verify_actionERKNS_6verifyEEUlRT_E_EEvRKS1_yOS8_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
  (local $7 i64)
  ...
  (drop
   (call $_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNS_7accountE
    (get_local $9)
    (get_local $1)
   )
  )
 ...
 (func $_ZN5eosiolsINS_10datastreamIPcEEEERT_S5_RKNS_7accountE (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (i32.store offset=4
   (i32.const 0)
 ...
 (func $_ZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE7emplaceIZN4impl15start_new_cycleEyyEUlRT_E3_EENS2_14const_iteratorEyOS5_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  ...
  (call $_ZZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE7emplaceIZN4impl15start_new_cycleEyyEUlRT_E3_EENS2_14const_iteratorEyOS5_ENKUlS6_E_clINS2_4itemEEEDaS6_
   (i32.add
    (get_local $7)
    (i32.const 16)
   )
 ...
 (func $_ZZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE7emplaceIZN4impl15start_new_cycleEyyEUlRT_E3_EENS2_14const_iteratorEyOS5_ENKUlS6_E_clINS2_4itemEEEDaS6_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i64)
  (local $5 i32)
 ...
 (func $_ZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE7emplaceIZN4impl12start_actionERKNS_5startEEUlRT_E3_EENS2_14const_iteratorEyOS8_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i32)
  ...
  (drop
   (call $_ZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE4itemC2IZNS2_7emplaceIZN4impl12start_actionERKNS_5startEEUlRT_E3_EENS2_14const_iteratorEyOSA_EUlSB_E_EEPKS2_SE_
    (tee_local $3
     (call $_Znwj
      (i32.const 48)
     )
 ...
 (func $_ZN5eosio11multi_indexILy14098107730740903936ENS_7sincomeEJEE4itemC2IZNS2_7emplaceIZN4impl12start_actionERKNS_5startEEUlRT_E3_EENS2_14const_iteratorEyOSA_EUlSB_E_EEPKS2_SE_ (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $_ZN5eosio14memory_manager16next_active_heapEv (param $0 i32) (result i32)
  ...
  (block $label$0
   (block $label$1
    (br_if $label$1
     (i32.eqz
      (i32.load8_u offset=12134
       (i32.const 0)
      )
     )
    )
    (set_local $7
     (i32.load offset=12136
      (i32.const 0)
     )
    )
    (br $label$0)
   ...
   (i32.store8 offset=12134
    (i32.const 0)
    (i32.const 1)
   )
   (i32.store offset=12136
    (i32.const 0)
    (tee_local $7
     (i32.shl
      (get_local $7)
